...
---
Looking at IMDB data on how users rate and score movies this project looks at the correlation between movie ratings and user votes. We shall extract data for the top 30 movies scored between March and July 2020.
...
```{r combine, include=TRUE, warning=FALSE}
