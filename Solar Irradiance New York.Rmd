---
title: "Guided project: new York Solar Irradiance"
...
Accessing data from the US government using their [Data Gov API](https://developer.nrel.gov/docs/solar/solar-resource-v1/#request-url) to access, extract and manupulate the Solar data for **New York City**.

**The goal:** To extract the solar resource data for New York City in JSON format and convert it into a dataframe.
...
#Set Key
key<-"xbGxUiY5LODjw38WfQMK9LuDsRaBrvQA59wgu0Io"
